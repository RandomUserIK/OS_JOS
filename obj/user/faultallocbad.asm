...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d42:	79 14                	jns    800d58 <set_pgfault_handler+0x3b>
			panic("set_pgfault_handler: sys_page_alloc failed!");
  800d44:	83 ec 04             	sub    $0x4,%esp
  800d47:	68 50 13 80 00       	push   $0x801350
  800d4c:	6a 22                	push   $0x22
  800d4e:	68 b4 13 80 00       	push   $0x8013b4
  ...
  800d79:	68 7c 13 80 00       	push   $0x80137c
  800d7e:	6a 29                	push   $0x29
  800d80:	68 b4 13 80 00       	push   $0x8013b4
