...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  800d3e:	85 db                	test   %ebx,%ebx
		pg = (void *) -1;
  800d40:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  800d45:	0f 44 d8             	cmove  %eax,%ebx
  800d48:	eb 1c                	jmp    800d66 <ipc_send+0x3a>
	...
	{
		if(r != -E_IPC_NOT_RECV)
  800d4a:	83 f8 f9             	cmp    $0xfffffff9,%eax
  800d4d:	74 12                	je     800d61 <ipc_send+0x35>
			panic("not -E_IPC_NOT_RECV %e", r);
  800d4f:	50                   	push   %eax
  800d50:	68 4f 13 80 00       	push   $0x80134f
  800d55:	6a 47                	push   $0x47
  800d57:	68 66 13 80 00       	push   $0x801366
  800d5c:	e8 58 00 00 00       	call   800db9 <_panic>

		if(r == 0)
			break;

		sys_yield();
  800d61:	e8 8f fd ff ff       	call   800af5 <sys_yield>
	if(!pg)
		pg = (void *) -1;
  ...
  800d6a:	56                   	push   %esi
  800d6b:	57                   	push   %edi
  800d6c:	e8 ee fe ff ff       	call   800c5f <sys_ipc_try_send>
  800d71:	83 c4 10             	add    $0x10,%esp
  800d74:	85 c0                	test   %eax,%eax
  800d76:	75 d2                	jne    800d4a <ipc_send+0x1e>
		if(r == 0)
			break;
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800dd5:	56                   	push   %esi
  800dd6:	50                   	push   %eax
  800dd7:	68 70 13 80 00       	push   $0x801370
