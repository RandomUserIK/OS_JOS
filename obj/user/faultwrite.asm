...
sys_env_destroy(envid_t envid)
{
  ...
  8000ef:	68 5e 0d 80 00       	push   $0x800d5e
  8000f4:	6a 23                	push   $0x23
  8000f6:	68 7b 0d 80 00       	push   $0x800d7b
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800143:	56                   	push   %esi
  800144:	50                   	push   %eax
  800145:	68 8c 0d 80 00       	push   $0x800d8c
  ...
  800156:	e8 54 00 00 00       	call   8001af <vcprintf>
	cprintf("\n");
  80015b:	c7 04 24 b0 0d 80 00 	movl   $0x800db0,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002ae:	0f be 80 b2 0d 80 00 	movsbl 0x800db2(%eax),%eax
  8002b5:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003aa:	ff 24 85 40 0e 80 00 	jmp    *0x800e40(,%eax,4)
  ...
  80046e:	8b 14 85 98 0f 80 00 	mov    0x800f98(,%eax,4),%edx
  800475:	85 d2                	test   %edx,%edx
  800477:	75 18                	jne    800491 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  800479:	50                   	push   %eax
  80047a:	68 ca 0d 80 00       	push   $0x800dca
  80047f:	53                   	push   %ebx
  800480:	56                   	push   %esi
  ...
  800491:	52                   	push   %edx
  800492:	68 d3 0d 80 00       	push   $0x800dd3
  800497:	53                   	push   %ebx
  800498:	56                   	push   %esi
  ...
  8004b6:	b8 c3 0d 80 00       	mov    $0x800dc3,%eax
