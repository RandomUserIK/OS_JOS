...
sys_env_destroy(envid_t envid)
{
  ...
  8000e7:	68 5e 0d 80 00       	push   $0x800d5e
  8000ec:	6a 23                	push   $0x23
  8000ee:	68 7b 0d 80 00       	push   $0x800d7b
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80013b:	56                   	push   %esi
  80013c:	50                   	push   %eax
  80013d:	68 8c 0d 80 00       	push   $0x800d8c
  ...
  80014e:	e8 54 00 00 00       	call   8001a7 <vcprintf>
	cprintf("\n");
  800153:	c7 04 24 b0 0d 80 00 	movl   $0x800db0,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8002a6:	0f be 80 b2 0d 80 00 	movsbl 0x800db2(%eax),%eax
  8002ad:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003a2:	ff 24 85 40 0e 80 00 	jmp    *0x800e40(,%eax,4)
  ...
  800461:	83 f8 06             	cmp    $0x6,%eax
  800464:	7f 0b                	jg     800471 <vprintfmt+0x142>
  800466:	8b 14 85 98 0f 80 00 	mov    0x800f98(,%eax,4),%edx
  80046d:	85 d2                	test   %edx,%edx
  80046f:	75 18                	jne    800489 <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  800471:	50                   	push   %eax
  800472:	68 ca 0d 80 00       	push   $0x800dca
  800477:	53                   	push   %ebx
  800478:	56                   	push   %esi
  ...
  800489:	52                   	push   %edx
  80048a:	68 d3 0d 80 00       	push   $0x800dd3
  80048f:	53                   	push   %ebx
  800490:	56                   	push   %esi
  ...
  8004ae:	b8 c3 0d 80 00       	mov    $0x800dc3,%eax
