...
set_pgfault_handler(void (*handler)(struct UTrapframe *utf))
{
  ...
  800d3c:	68 b0 12 80 00       	push   $0x8012b0
  800d41:	6a 29                	push   $0x29
  800d43:	68 e8 12 80 00       	push   $0x8012e8
