	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001d7:	0f be 80 95 0d 80 00 	movsbl 0x800d95(%eax),%eax
  8001de:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8002d3:	ff 24 85 24 0e 80 00 	jmp    *0x800e24(,%eax,4)
  ...
  800397:	8b 14 85 7c 0f 80 00 	mov    0x800f7c(,%eax,4),%edx
  80039e:	85 d2                	test   %edx,%edx
  8003a0:	75 18                	jne    8003ba <vprintfmt+0x15a>
				printfmt(putch, putdat, "error %d", err);
  8003a2:	50                   	push   %eax
  8003a3:	68 ad 0d 80 00       	push   $0x800dad
  8003a8:	53                   	push   %ebx
  8003a9:	56                   	push   %esi
  ...
  8003ba:	52                   	push   %edx
  8003bb:	68 b6 0d 80 00       	push   $0x800db6
  8003c0:	53                   	push   %ebx
  8003c1:	56                   	push   %esi
  ...
  8003df:	b8 a6 0d 80 00       	mov    $0x800da6,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800a5a:	68 98 0f 80 00       	push   $0x800f98
  800a5f:	6a 23                	push   $0x23
  800a61:	68 b5 0f 80 00       	push   $0x800fb5
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800aae:	56                   	push   %esi
  800aaf:	50                   	push   %eax
  800ab0:	68 c4 0f 80 00       	push   $0x800fc4
  ...
  800ac1:	e8 12 f6 ff ff       	call   8000d8 <vcprintf>
	cprintf("\n");
  800ac6:	c7 04 24 e8 0f 80 00 	movl   $0x800fe8,(%esp)
